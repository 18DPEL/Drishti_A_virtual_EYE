...
def image_processing_script(led,button,output_file):
    ...
    while True:
        text = "DRISHTI is currently analyzing the environment. Ensure the AI-enabled cap is properly connected and positioned."
        text_to_speech(text, output_file)
        ...
        text = "AI analysis in progress. Front view information is being generated, it may take few seconds, your patience is appreciated."
        text_to_speech(text, output_file)
...
def main():
    ...
    text = "Welcome to DRISHTI AI. a ennovative creation to assist blind person in the light of AI"
    text_to_speech(text, output_file)
